...
export function LifecycleActions({ user, allowed, onChanged }) {
  ...
  return (
    <section className="admin-lifecycle-actions" aria-labelledby="lifecycle-actions-title">
      <div><p className="admin-section-label">Account controls</p><h2 id="lifecycle-actions-title">Account actions</h2><span>Confirmed changes are recorded in the audit history.</span></div>
