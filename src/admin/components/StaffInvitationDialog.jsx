  ...
  return (
    <dialog ref={dialogRef} className="admin-dialog" aria-labelledby="staff-invitation-title" aria-describedby="staff-invitation-description">
      <form method="dialog" className="admin-dialog__surface" onSubmit={(event) => { event.preventDefault(); if (valid && !submitting) void onConfirm(proposal) }}>
        ...
        <p id="staff-invitation-description">Create one invitation valid for 72 hours. Acceptance revalidates and applies this exact access package.</p>
        <div className="admin-organization-form">
          ...
          <div className="admin-dialog__target"><strong>Employment</strong><span>These values are revalidated when the invitation is accepted.</span></div>
          ...
          <div className="admin-dialog__target"><strong>Authorization</strong><span>Choose one exact server-approved role and scope.</span></div>
