...
export function ReactiveComparisonPage() {
  ...
  return <main className="fx-2b-review">
    ...
    <section className="fx-2b-intro">
      ...
      <span>Compare the current symbol with the moving eight-color material. Both previews share the same cycle, with a slightly different starting point. Move the pointer toward the Orb and button. This page is not part of normal navigation.</span>
    ...
    <div className="fx-2b-grid">
      ...
      <section className="fx-2b-card fx-2b-card--new fx-2b-card--ice">
        <p>B · Full spectrum, cooler start</p>
