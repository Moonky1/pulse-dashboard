  ...
  return (
    <AuthShell eyebrow="Welcome back" title="Sign in to Pulse" footer={<><span>New to Pulse?</span> <Link to={STAFF_REGISTER_PATH}>Create an account</Link></>}>
      <form className="auth-form" onSubmit={submit} noValidate>
        ...
        <Button className="auth-holo-action" type="submit" size="lg" loading={submitting}>Sign in</Button>
        <div className="auth-option-divider" role="separator"><span>or</span></div>
        <Button className="auth-holo-action" type="button" size="lg" variant="secondary" onClick={() => setGoogleNotice('Google sign-in is coming soon.')}>
