...
import { ProductMark, ProductTopbar } from '../components/ProductNavigation.jsx'
    ...
    <div className="product-surface product-workspace">
      ...
      <main className="product-content">
        ...
        <div className="product-workspace__apps">
          <Link className="auth-workspace-destination auth-workspace-destination--dashboard" to="/dashboard"><ProductMark /><span><strong>Dashboard</strong><small>Your Pulse overview</small></span><b aria-hidden="true">↗</b></Link>
