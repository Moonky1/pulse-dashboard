...
function useSound() {
  ...
  return {
    correct: () => {
      b(600, 0.1)
      setTimeout(() => b(900, 0.15), 100)
    },
    wrong: () => b(180, 0.35, 'sawtooth', 0.15),
    tick: () => b(500, 0.04, 'square', 0.06),
    start: () => {
      b(400, 0.08)
      setTimeout(() => b(600, 0.1), 150)
      setTimeout(() => b(800, 0.15), 300)
    },
    join: () => b(520, 0.12),
    ding: () => {
      b(800, 0.08)
      setTimeout(() => b(1000, 0.12), 80)
    },
  }
}
                ...
                <div key={i} className="grm-bar-row">
                  ...
                  <div className="grm-bar-bg">
                    <div
                      ...
                      style={{ width: `${answeredN > 0 ? (cnt / answeredN) * 100 : 0}%`, background: OPTS[i].c }}
                    />
                  </div>
