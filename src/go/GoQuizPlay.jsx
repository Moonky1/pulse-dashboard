...
export default function GoQuizPlay() {
  ...
  const timerColor =
    timeLeft <= 5 ? '#ef4444' : timeLeft <= 10 ? '#f59e0b' : '#f97316'
      ...
      <div className="gqp-page">
        ...
        <div className="gqp-results">
          ...
          <div className="gqp-results-row">
            ...
            <div className="gqp-results-stat">
              <span className="gqp-results-num" style={{ color: '#6b7280' }}>
                {QUESTION_COUNT}
              </span>
  ...
  return (
    <div className="gqp-page">
      <nav className="gqp-nav">
        ...
        <button className="gqp-nav-exit" onClick={() => navigate('/go/quiz')}>
          ✕ Exit
        </button>
      </nav>
