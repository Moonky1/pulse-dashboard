...
function DialerGuideView() {
  return (
    <div>
      ...
      <div style={{ marginBottom: 8, fontSize: 13, color: '#f59e0b', background: 'rgba(245,158,11,0.08)', padding: '10px 14px', borderRadius: 8, marginBottom: 16 }}>
      ...
      <TrainingImg src="vici-lead-form.png" alt="VICIdial Lead Form" caption="✓ USE: First/Last Name, Loan Monthly Cost (= monthly payment), Origination Date (= loan date), Loan Balance — ✗ NEVER mention: Address, Finance Company, Terms of Loan" />
