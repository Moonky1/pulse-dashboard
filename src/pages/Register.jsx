  ...
  return (
    <div className="auth-welcome-overlay">
      ...
      <div className="auth-welcome-card">
        ...
        <div className="auth-welcome-kicker">Welcome</div>
        <div className="auth-welcome-name">{name}</div>
        <div className="auth-welcome-sub">Creating your workspace...</div>
      </div>
    </div>
  )
}

export default function Register({ embedded = false, onClose, onSwitchMode }) {
      ...
      <div className="reg-card auth-modal-card">
        ...
        <div className="reg-actions">
          {step > 0 && (
            <button
              ...
              disabled={saving || Boolean(welcomeName)}
            >
              ← Back
            </button>
          )}
        ...
        {step === 0 && (
          <p className="auth-switch-text">
            Already registered?{' '}
            <span onClick={switchToSignIn}>Sign in instead</span>
          </p>
        )}
      </div>
    </>
